...
namespace WebApp_7lab.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public FilmsController(EFDbcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("film_id,film,main_director,budget")] Films films)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("film_id,film,main_director,budget")] Films films)
        {
            if (id != films.film_id)
            {
                return NotFound();
